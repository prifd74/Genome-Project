...
module.exports = {
    ...
    execute(client) {
        ...
        const activities = [
            { name: 'Genome.anime', type: ActivityType.Watching },
            { name: 'Genome Project', type: ActivityType.Playing },
            { name: 'on GenomeTube', type: ActivityType.Streaming },
            { name: 'Genomify', type: ActivityType.Listening },
        ];
